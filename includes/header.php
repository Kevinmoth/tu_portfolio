...
$hero_titulo = obtener_config('hero_titulo') ?? 'Bienvenido a mi Portfolio';
$hero_subtitulo = obtener_config('hero_subtitulo') ?? '';
$hero_cta_texto = obtener_config('hero_cta_texto') ?? 'Ver Proyectos';
$color_primario = obtener_config('color_primario') ?? '#4a90e2';
$color_secundario = obtener_config('color_secundario') ?? '#2c5aa0';
$footer_texto = obtener_config('footer_texto') ?? '';
...
<head>
    ...
    <style>
        :root {
            --primary-blue: <?php echo htmlspecialchars($color_primario); ?>;
            --dark-blue: <?php echo htmlspecialchars($color_secundario); ?>;
            --light-gray: #f5f5f5;
            --card-gray: #e8e8e8;
            --text-dark: #333333;
        }
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php
                    $cats = $conn->query("SELECT nombre, slug FROM categorias ORDER BY id");
                    while ($cat = $cats->fetch_assoc()):
                        $activo = (isset($_GET['slug']) && $_GET['slug'] === $cat['slug']) ? 'active' : '';
                    ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $activo; ?>" href="categoria.php?slug=<?php echo urlencode($cat['slug']); ?>">
