...
<style>
    ...
    .proyecto-relacionado-card:hover {
            ...
            <div class="col-md-8">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="background: transparent; padding: 0;">
                        ...
                        <li class="breadcrumb-item">
                            <a href="categoria.php?slug=<?php echo urlencode($proyecto['categoria_slug']); ?>" style="color: rgba(255,255,255,0.8);">
...
<div class="container mb-5">
            ...
            <?php if ($proyecto['imagen']): ?>
                <div class="mb-4">
                    <img src="includes/conexion.php?img=proyecto&id=<?php echo $proyecto['id']; ?>" 
                         ...
                         class="proyecto-imagen-principal">
                </div>
            <?php endif; ?>
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body p-4">
                    ...
                    <div>
                        ...
                        ?>
                            <span class="tech-badge me-2 mb-2" style="background-color: <?php echo $tech['color']; ?>; font-size: 1.1rem; padding: 8px 15px;">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-grid gap-3">
                        ...
                        <?php if ($proyecto['url_repo']): ?>
                            <a href="<?php echo htmlspecialchars($proyecto['url_repo']); ?>" 
                               target="_blank"
    ...
    <div class="text-center mt-5">
        <a href="categoria.php?slug=<?php echo urlencode($proyecto['categoria_slug']); ?>" class="btn btn-outline-primary btn-lg">
