...
// Obtener ID de categoría "Scripts"
$categoria_query = $conn->prepare("SELECT id FROM categorias WHERE slug = 'scripts'");
...
<div class="container my-5">
    <div class="text-center mb-5">
        <h1 class="display-4">
            <i class="bi bi-code-slash" style="color: var(--primary-blue);"></i> Scripts
        </h1>
        <p class="lead text-muted">Scripts y utilidades para automatización</p>
    </div>
    
    <!-- Barra de búsqueda -->
    <div class="search-box">
        <form method="GET" action="scripts.php">
    ...
    <?php if ($busqueda): ?>
        <div class="text-center mb-4">
            <p class="text-muted">
                ...
                (<?php echo $total_proyectos; ?> script<?php echo $total_proyectos != 1 ? 's' : ''; ?>)
                <a href="scripts.php" class="btn btn-sm btn-outline-secondary ms-2">Limpiar</a>
            </p>
        </div>
    <?php endif; ?>
    ...
    <?php else: ?>
        <div class="text-center py-5">
            ...
            <p class="text-muted">
                <?php echo $busqueda ? 'Intenta con otros términos de búsqueda' : 'Aún no hay scripts publicados'; ?>
            </p>
        </div>
    <?php endif; ?>
</div>
